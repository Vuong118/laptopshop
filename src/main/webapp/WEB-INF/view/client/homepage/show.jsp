                                                        ...
                                                        <div class="col-md-6 col-lg-4 col-xl-3">
                                                            <div class="rounded position-relative fruite-item h-100 d-flex flex-column border">
                                                                ...
                                                                <div class="p-4 rounded-bottom d-flex flex-column">
                                                                    ...
                                                                    <div class="d-flex flex-lg-wrap justify-content-sm-center mt-auto">
                                                                        <p style="font-size: 15px; text-align: center; width:100%;" class="text-dark fw-bold mb-3">
                                                                            <fmt:formatNumber type="number" value="${product.price}" />đ
                                                                        </p>
                                                                        <form action="/add-product-to-cart/${product.id}" method="post">
                                                                            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                                                                            <button class="mx-auto btn border border-secondary rounded-pill px-3 text-primary" class="fa fa-shopping-bag me-2 text-primary"> Add to cart</button></form>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
